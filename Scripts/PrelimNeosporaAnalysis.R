...
dir.create("PremPremResults", showWarnings = FALSE)
  ...
  #### eps ####
parms <- expand.grid(list(alpha=0.3,
                     betas=0.02,
                     betaI=0.08,
                     rhov=0.9,
                     delta=0.1,
...
res_InitN <- proc_res("PremResults", parms, plot_name = "initN_model_plot.png")
res_InitN
...
res_NoNeo <- proc_res("PremResults", parms, plot_name = "NoNeo_model_plot.png")
res_NoNeo
...
proc_res("PremResults", parms, plot_name = "OneP_model_plot.png")
